...
/* For mapping android gamepads, and/or the first player on OUYA */
...
/* For mapping second, third and fourth players on OUYA (has no effect on other devices) */
extern DECLSPEC void SDLCALL SDL_ANDROID_set_ouya_gamepad_keymap(int player, int up, int right, int left, int down, int O, int A, int U, int Y, int L1, int R1, int L2, int R2, int LT, int RT);
